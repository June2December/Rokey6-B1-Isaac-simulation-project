...
class RoverTerrainImporter(TerrainImporter):
    ...
    def _spawn_basecamp_walls(self, basecamp_size_m: float = 10.0, wall_height: float = 0.01, wall_thickness: float = 0.001):
        ...
        flat_h = 0.05        # 실제 렌더 높이 = 0.05 × 2 = 0.1m (10cm 납작)
        center_z = float(hm.heightmap[cy_grid, cx_grid]) + flat_h  # 바닥이 정확히 지형면에 닿음
        ...
        wall_specs = [
            ("north_wall", (center_x,        center_y + half, center_z+1.7), (wl,             wall_thickness, flat_h)),
            ("south_wall", (center_x,        center_y - half, center_z+1.7), (wl,             wall_thickness, flat_h)),
            ("east_wall",  (center_x + half, center_y,        center_z+1.7), (wall_thickness, wl,             flat_h)),
            ("west_wall",  (center_x - half, center_y,        center_z+1.7), (wall_thickness, wl,             flat_h)),
        ]
